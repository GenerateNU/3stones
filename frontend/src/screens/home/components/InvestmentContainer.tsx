  ...
  return (
    <StyledView className='w-[full] h-[10vh] flex flex-row justify-center items-center'>
      <StyledView className='flex flex-1 flex-row space-x-[17vw]'>
        <StyledImage source={{uri: image}} className='w-[13vw] h-[13vw] bg-black rounded-full'></StyledImage>
      ...
      <StyledView className='flex flex-col flex-2 space-y-[5vh]'>
        <StyledText className="font-sourceSans3Bold text-[4.5vw] text-right">${amount.toLocaleString()}</StyledText>
        <StyledText className="font-sourceSans3 text-[3vw] text-success text-right">{status}</StyledText>
      </StyledView>

      <StyledImage source={require('../../../../assets/images/chevron-right-black.png')} className="w-[7vw] h-[7vw] ml-[5vw] flex-3"></StyledImage>
