...
import { Image, Text, View, TouchableOpacity, DimensionValue, ScrollView } from 'react-native';
    ...
    <StyledView className='flex-1'>
      ...
      >
        ...
        <Card className='p-8'>
          ...
          <StyledText className='font-sourceSans3 text-base leading-5 py-6'>
            {project.description}
          </StyledText>
      ...
      <StyledView className='w-full px-6 py-6 absolute bottom-0'>
        <Button
          ...
          type='primary'
          onPress={() => {
            navigation.navigate('project-invest', { projectId: projectId });
          }}
        >
          Invest
        </Button>
