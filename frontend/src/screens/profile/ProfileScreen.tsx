...
import { BodyBoldText, BodyText, HeadingText, SubheadingText } from '../../components/typography';
...
const EditProfileButton = ({ navigation }) => {
    return (
        <StyledView className='h-[4vh] w-[20vh]'>
            <Button onPress={() => {navigation.navigate('profile-edit')}} type='secondary'>Edit Profile</Button>
        </StyledView>
    );
};
