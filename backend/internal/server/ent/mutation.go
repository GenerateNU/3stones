...
func (m *RefreshTokenMutation) SetRefreshTokenHash(s string) {
	m.refresh_token_hash = &s
}

// RefreshTokenHash returns the value of the "refresh_token_hash" field in the mutation.
func (m *RefreshTokenMutation) RefreshTokenHash() (r string, exists bool) {
...
// OldRefreshTokenHash returns the old "refresh_token_hash" field's value of the RefreshToken entity.
// If the RefreshToken object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *RefreshTokenMutation) OldRefreshTokenHash(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *RefreshTokenMutation) ResetRefreshTokenHash() {
...
func (m *RefreshTokenMutation) Fields() []string {
	...
	if m.refresh_token_hash != nil {
		fields = append(fields, refreshtoken.FieldRefreshTokenHash)
	}
	return fields
}
...
type UserMutation struct {
	...
	password             *string
	clearedFields        map[string]struct{}
	refresh_token        map[int]struct{}
	removedrefresh_token map[int]struct{}
...
func (m *UserMutation) AddRefreshTokenIDs(ids ...int) {
	if m.refresh_token == nil {
		m.refresh_token = make(map[int]struct{})
	}
	for i := range ids {
...
func (m *UserMutation) RemoveRefreshTokenIDs(ids ...int) {
	if m.removedrefresh_token == nil {
		m.removedrefresh_token = make(map[int]struct{})
	}
	for i := range ids {
...
func (m *UserMutation) RemovedRefreshTokenIDs() (ids []int) {
...
func (m *UserMutation) RefreshTokenIDs() (ids []int) {
