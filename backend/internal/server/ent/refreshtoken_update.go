...
func (rtu *RefreshTokenUpdate) SetRefreshTokenHash(s string) *RefreshTokenUpdate {
	rtu.mutation.SetRefreshTokenHash(s)
	return rtu
}

// SetNillableRefreshTokenHash sets the "refresh_token_hash" field if the given value is not nil.
func (rtu *RefreshTokenUpdate) SetNillableRefreshTokenHash(s *string) *RefreshTokenUpdate {
	if s != nil {
		rtu.SetRefreshTokenHash(*s)
	}
	return rtu
}
...
func (rtu *RefreshTokenUpdate) check() error {
	if v, ok := rtu.mutation.RefreshTokenHash(); ok {
...
func (rtu *RefreshTokenUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := rtu.mutation.RefreshTokenHash(); ok {
...
// SetRefreshTokenHash sets the "refresh_token_hash" field.
func (rtuo *RefreshTokenUpdateOne) SetRefreshTokenHash(s string) *RefreshTokenUpdateOne {
	rtuo.mutation.SetRefreshTokenHash(s)
	return rtuo
}

// SetNillableRefreshTokenHash sets the "refresh_token_hash" field if the given value is not nil.
func (rtuo *RefreshTokenUpdateOne) SetNillableRefreshTokenHash(s *string) *RefreshTokenUpdateOne {
	if s != nil {
		rtuo.SetRefreshTokenHash(*s)
	}
	return rtuo
}
...
func (rtuo *RefreshTokenUpdateOne) check() error {
	if v, ok := rtuo.mutation.RefreshTokenHash(); ok {
		if err := refreshtoken.RefreshTokenHashValidator(v); err != nil {
			return &ValidationError{Name: "refresh_token_hash", err: fmt.Errorf(`ent: validator failed for field "RefreshToken.refresh_token_hash": %w`, err)}
		}
	}
...
func (rtuo *RefreshTokenUpdateOne) sqlSave(ctx context.Context) (_node *RefreshToken, err error) {
	...
	if value, ok := rtuo.mutation.RefreshTokenHash(); ok {
		_spec.SetField(refreshtoken.FieldRefreshTokenHash, field.TypeString, value)
	}
