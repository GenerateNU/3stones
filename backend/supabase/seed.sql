...
INSERT INTO developers (id, name, description, location) VALUES ('f9ad1bd6-8b5a-41e0-aacf-56fe3cde2e2a', 'Capital Construction', 'Design, build, and lead construction projects', 'Boston');
INSERT INTO developers (id, name, description, location) VALUES ('c2128c81-e4db-4695-8be7-089f12d5ea46', 'Developer 1', 'Developer 1 description', 'Developer 1 location');
