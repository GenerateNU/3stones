...
INSERT INTO projects (id, developer_id, title, description, completed, funding_goal_cents, milestone, premise, street, locality, state, zipcode) VALUES ('c3733692-5a86-441f-8ad0-9c32c648bb72', '56ebee48-d844-4fcd-aa58-fb71688c3e81', 'Bowser Castle', 'A big fiery castle sitting on prime real estate', 'FALSE', '100000000', 'Land Control Secured', '7', 'Speare Pl', 'Boston', 'MA', '02115');
INSERT INTO projects (id, developer_id, title, description, completed, funding_goal_cents, milestone, premise, street, locality, state, zipcode) VALUES ('d09c8f0f-13d3-4336-92e9-b0b2c8bce570', '56ebee48-d844-4fcd-aa58-fb71688c3e81', 'Spongebob Pineapple', 'A pineapple under the sea', 'TRUE', '18000000', 'Construction Completed', '7', 'Speare Pl', 'Boston', 'MA', '02115');
